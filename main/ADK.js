...
define([
    ...
    "main/ADKApp"
], function(Backbone, Marionette, $, _, CCOWService, resourceService, userService, session, UIComponents, utils, messaging, navigation, autoLogoff, sessionStorage, errorMessaging, UserDefinedScreens, Enrichment, DataGrid, Filter, Paginator, AppletControllerView, GridAppletView, Workflow, LoadingView, ErrorView, ServerSideErrorView, SignView, SignApi, EventsGistView, PillGistView, InterventionsGistView, ObservationsGist, PanelsGistView, baseDisplayApplet, gridView, pillsGistView, interventionsGistView, eventsGistView, ObservationsGistView, panelsGistView, ToolbarView, ChromeView, Popup, tileSortManager, ADKApp) {
    'use strict';
    ADK = {
