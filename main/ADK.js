var dependencies = [
    ...
    "main/components/views/gists/vitalsView/vitalsGistView",
    "main/components/views/gists/labresultsView/labresultsGistView",
    "api/SessionStorage",
    "api/ErrorMessaging",
...
function onResolveDependencies(Backbone, Marionette, $, _, resourceService, userService, session, utils, messaging, navigation, autoLogoff, DataGrid, Filter, Paginator, AppletControllerView, GridAppletView, ModalView, WorkflowModalView, FullscreenOverlayView, LoadingView, ErrorView, ServerSideErrorView, EventsGistView, PillGistView, InterventionsGistView, VitalsGistView, LabresultsGistView, sessionStorage, errorMessaging, baseDisplayApplet, gridView, pillsGistView, interventionsGistView, eventsGistView) {
    'use strict';
    var ADK = {
    ...
    ADK.Views = {
        ...
        VitalsGist: VitalsGistView,
        LabresultsGist: LabresultsGistView
    };
    ...
    ADK.createSimpleApplet = function(appletDefinition) {
        ...
        var applet = {
            ...
            //     var domainCollection = ADK.PatientRecordService.fetchCollection(session.patient, appletDefinition.resource, appletDefinition.viewModel);

            //     // or...
            //     //var domainCollection = app.patient.clinicaldata.fetch('allergies', viewModel);

            //     var appletCompositeView = ADK.TableCompositeView(appletDefinition.rowTemplate, appletDefinition.tableTemplate, domainCollection);

            //     rootView.appletMain.show(appletCompositeView);
            // }
        };
