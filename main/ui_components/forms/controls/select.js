    ...
    var SelectPrototype = {
        ...
        needMoreInput: function (searchInput) {
            ...
            if (searchInput !== undefined && searchInput !== null) {
                // Needed for Select2 508 to work in Modals and Tabs
                var parentContainer = this.$el.closest('.workflow-container');
        ...
        initSelect2: function() {
            ...
            if (fetchEnabled) {
                ...
                this.$el.find('select').select2(this.field.get('options'));
            }
