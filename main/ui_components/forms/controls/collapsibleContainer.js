      ...
      events: _.defaults({
        'control:collapsed': function(event, booleanValue) {
          if(_.isBoolean(booleanValue)) {
            ...
            if(booleanValue) {
              this.$el.find('button#collapsibleContainerTrigger').addClass('collapsed');
            } else {
              this.$el.find('button#collapsibleContainerTrigger').removeClass('collapsed');
            }
        ...
        'control:collapsibleContainer:disableButton': function(event, booleanValue) {
          if(_.isBoolean(booleanValue)) {
            ...
            this.$el.find('button#collapsibleContainerTrigger').prop('disabled', disableString);
          }
        }
