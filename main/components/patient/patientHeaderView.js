                    ...
                    if (cwadContainer.attr('data-current-cwad') === cwadLabel.attr('data-cwadidentifier')) {
                        ...
                        switch ($(event.target).attr('data-cwadidentifier')) {
                            ...
                            case 'D':
                                ...
                                cwadDetailConfig.cwadDescription = '"Advance Directives" is under development and may not return all expected results.  Please review the patient record manually to ensure accuracy.';
                                this.cwadDetails.show(this.createCwadDetailView(cwadDetailConfig));
                                break;
                            case 'F':
