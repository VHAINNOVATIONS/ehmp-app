define([
    ...
    var MaximizedAppletModel = Backbone.Model.extend({
        defaults: {
            ...
            'maximizedAppletId': undefined,
            'maximizedScreenId': undefined,
            'filterName': ''
        }
    });
    ...
    var ChromeLayoutView = Backbone.Marionette.LayoutView.extend({
        ...
        onBeforeDestroy: function() {
            var appletInstanceId = this.model.get('instanceId');
            WorkspaceFilters.offAppletFilterCollectionChanged(appletInstanceId);
        },
        ...
        expandApplet: function(event) {
            ...
            ADK.Messaging.reply("applet:maximized", function() {
                return new MaximizedAppletModel({
                    instanceId: self.options.appletConfig.instanceId,
                    workspaceId: workspaceId,
                    maximizedAppletId: self.options.appletConfig.id,
                    maximizedScreenId: self.options.appletConfig.maximizeScreen,
                    filterName: self.options.appletConfig.filterName
                });
            });
