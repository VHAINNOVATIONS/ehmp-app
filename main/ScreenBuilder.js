define([
    ...
    ScreenBuilder.initAllRouters = function(app) {
        ...
        promise.done(function(screensConfig) {
            ...
            _.each(additionalScreens, function(screen) {
                ...
                if( !_.isUndefined(matchingScreen) && matchingScreen.hasOwnProperty('hasPermission')) {
                    screen.hasPermission = matchingScreen.hasPermission;
                }
    ...
    ScreenBuilder.buildAll = function(marionetteApp) {
         ...
         **/
        if (Session.user.get('status') === 'loggedout') {
        ...
        _.each(applets, function(applet) {
            ...
            require(['app/applets/' + applet.id + '/applet'], function(appletPojo) {
                appletPojo.hasPermission = applet.hasPermission;
    ...
    ScreenBuilder.build = function(marionetteApp, screenConfig) {
        ...
        if (!_.isUndefined(matchingScreen.hasPermission)) {
            screenConfig.hasPermission = matchingScreen.hasPermission;
        }
        return builtScreen;
    };
