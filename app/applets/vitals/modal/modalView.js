...
function onResolveDependencies($, InputMask, ADK, Backbone, Marionette, _, Highcharts, Util, AppletHelper, dateTemplate, FilterDateRangeView, chartView, observedTemplate, resultTemplate, dateRangeTemplate, modalTemplate, totalTestsTemplate, siteTemplate, detailsFooterTemplate, modalHeader) {
    'use strict';
    ...
    var ChartView = Backbone.Marionette.ItemView.extend({
        ...
        initialize: function(options) {
            ...
            if (modalDisplayName == 'BP') {
                this.chartOptions.series[0].name = 'Systolic';
