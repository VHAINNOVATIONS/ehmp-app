var dependencies = [
    ...
    'hbs!app/applets/vitals/modal/dateRangeHeaderTemplate'
];
...
function onResolveDependencies($, InputMask, DatePicker, moment, ADK, Backbone, Marionette, _, dateRangeTemplate, dateRangeHeaderTemplate) {
    ...
    var FilterDateRangeView = Backbone.Marionette.LayoutView.extend({
        ...
        setDatePickers: function(fromDate, toDate) {
            var fromDateEl = this.$('#filter-from-date'),
                toDateEl = this.$('#filter-to-date');
        ...
        onRender: function(event) {
            ...
            if (selectedId !== undefined && selectedId !== null) {
                ...
                if (this.fullScreen) {
                    selectedId = $('[data-appletid=\'vitals\'] .grid-filter-daterange .active-range').attr('id');
