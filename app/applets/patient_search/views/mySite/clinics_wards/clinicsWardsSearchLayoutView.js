...
function onResolveDependencies(Backbone, Marionette, ADK, SearchResultsCollectionView, ErrorMessageView, BlankView, LocationsListResultsView, SearchViewTemplate, dateRangeSelectorView) {
    ...
    var LocationsListFilterView = Backbone.Marionette.ItemView.extend({
        template: _.template("<input type='text' placeholder='Filter <%=locationType%>' class='form-control padding'></input>"),
    ...
    var LocationsListFilterViewClinics = Backbone.Marionette.LayoutView.extend({
        template: _.template("<input type='text' placeholder='Filter <%=locationType%>' class='form-control padding'></input><div id='locationDateRange'></div>"),
