...
function onResolveDependencies($, InputMask, DatePicker, moment, Backbone, Marionette, _, dateRangeSelectorTemplate) {

    var DateRangeModel = Backbone.Model.extend({
        defaults: {
            fromDate: moment().subtract('years', 1).format('YYYYMMDD'),
