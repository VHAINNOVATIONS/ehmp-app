...
function onResolveDependencies($, InputMask, Backbone, Marionette, searchParamsValidator, globalSearchInputTemplate) {
    ...
    var GlobalSearchInputView = Backbone.Marionette.ItemView.extend({
        ...
        retrieveGlobalSearchParameters: function() {
            var params = {
                lname: this.$el.find('#globalSearchLastName').val().trim().toUpperCase(),
                fname: this.$el.find('#globalSearchFirstName').val().trim().toUpperCase(),
