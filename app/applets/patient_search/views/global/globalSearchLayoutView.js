...
function onResolveDependencies(Backbone, Marionette, ADK, SearchResultsCollectionView, BlankView, globalSearchResultsTemplate) {
    ...
    var GlobalLayoutView = Backbone.Marionette.LayoutView.extend({
        ...
        removeEmptyGlobalSearchCriteria: function(criteria) {
            ...
            if (newCriteria.fname === '') {
                delete newCriteria.fname;
            }
            if (newCriteria.dob === '') {
