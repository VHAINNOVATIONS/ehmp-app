...
function onResolveDependencies(Backbone, Marionette, _, ADK, patientSearchTemplate, TabView, InputView, PillsView, SearchMainView, ConfirmationView, CloseButtonView) {
