...
function onResolveDependencies(_, ADK, Backbone, Marionette, $, EditorFormTemplate, addScreenTemplate, deleteActiveTemplate, ScreenSelectionSlider, gridster, ScreenBuilder, UserDefinedScreens) {

    'use strict';

    //----- Shared functions for Add Screen form and Edit Screen form -----//

    var validator = function(self, screenTitle, screenDescription) {
    ...
    var AddEditViews = {
        ...
        EditorFormView: Backbone.Marionette.ItemView.extend({
            ...
            validateAndSave: function() {
                ...
                var hasError = validator(self, newScreenTitle, newScreenDescription);
                var editsMade = false;
        ...
        DeleteActiveView: Backbone.Marionette.ItemView.extend({
            ...
            initialize: function() {
                ...
                if (Backbone.history.fragment === screenCheck.id){
                    $('.editScreenForm').hide();
                }else{
        ...
        AddScreenView: Backbone.Marionette.ItemView.extend({
            ...
            validateInput: function() {
                ...
                var screenId;
                var hasError = validator(self, screenTitle, screenDescription);
                ...
                if (!hasError) {
                    if(!screenTitleExists(self, screenTitle.value)){
                        ...
                        promise.done(function(screensConfig) {
                            ...
                            self.addAndLoadScreen(screenId, screenDescription.value, screenTitle.value);
                        });
                    }
                }
            },
