...
function onResolveDependencies(ADK, _, InputMask, Session, modalTemplate, visitItemTemplate, newVisitTemplate, selectedVisitTemplate, Typeahead, footerTemplate, VisitUtil) {
    ...
    var footerView = Backbone.Marionette.ItemView.extend({
        ...
        handleNext: function(event) {
            ...
            if (modalView.getSelectedVisit().get('existingVisit') || modalView.isDataValid()) {
                ...
                Session.addModel('patient', newPatientModel);
