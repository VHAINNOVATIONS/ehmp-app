...
function onResolveDependencies(Backbone, Marionette, _, addVitalsTemplate, visitTemplate, footerTemplate, DateTimeView, VitalsCollectionView, modelUtils, dateUtil, SaveUtil, viewHelper, ADK) {
    'use strict';
