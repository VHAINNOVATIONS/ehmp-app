...
function onResolveDependencies($, InputMask, moment, ADK, Backbone, Marionette, _, Highcharts, HighchartsMore, AppletHelper, dateTemplate, resultTemplate, siteTemplate,
    ...
    var ModalView = Backbone.Marionette.LayoutView.extend({
        ...
        initialize: function(options) {
            ...
            this.fetchOptions.criteria = {
                typeName: this.model.attributes.typeName, // "Calcium, Serum or Plasma Quantitative",
