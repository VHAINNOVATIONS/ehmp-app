...
function onResolveDependencies(_, ADK, Backbone, Marionette, appletSlider, appletsManifest) {
    ...
    var AppletSliderLayoutView = Backbone.Marionette.LayoutView.extend({
        ...
        initialize: function(options) {
            this.collection = new Backbone.Collection(_.filter(appletsManifest.applets, function(applet) {
                return applet.showInUDWSelection;
            }));
            ...
            this.$el.find('.item').drag({
                ...
                stop: function(evt, ui) {
                    ...
                    addAppletsChannel.request('addAppletToGridster', {
                        ...
                        appletTitle: $(this).text(), //when appletConfig is figured out, this should be removed
                        sizeX: 4,
                        sizeY: 4,
                        //col: col,
                        //row: row,
