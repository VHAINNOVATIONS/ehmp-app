...
function onResolveDependencies(Backbone, Marionette, ADK, Moment, searchUtil, searchTemplate, searchSuggestTemplate, searchResultTemplate, searchResultGroupTemplate, inputmask, datepicker, underscore) {
    ...
    var SearchView = Backbone.Marionette.ItemView.extend({
        ...
        onBeforeDestroy: function() {
            ...
            ADK.Messaging.getChannel('search').off('newSearch');
        },
        initialize: function() {
            var self = this;
            ...
            ADK.Messaging.getChannel('search').on('newSearch', function() {
                if (storageText) {
                    ...
                    if (self.filterType === "all") {
                        ...
                        self.$('#all-range-global').addClass('active-range');
                    } else if (self.filterType === "2y") {
                        self.$('.active-range').removeClass('active-range');
                        self.$('#2yr-range-global').addClass('active-range');
                    } else if (self.filterType === "1y") {
                        self.$('.active-range').removeClass('active-range');
                        self.$('#1yr-range-global').addClass('active-range');
                    } else if (self.filterType === "3m") {
                        self.$('.active-range').removeClass('active-range');
                        self.$('#3mo-range-global').addClass('active-range');
                    } else if (self.filterType === "1m") {
                        self.$('.active-range').removeClass('active-range');
                        self.$('#1mo-range-global').addClass('active-range');
                    } else if (self.filterType === "7d") {
                        self.$('.active-range').removeClass('active-range');
                        self.$('#7d-range-global').addClass('active-range');
                    } else if (self.filterType === "72hr") {
                        self.$('.active-range').removeClass('active-range');
                        self.$('#72hr-range-global').addClass('active-range');
                    } else if (self.filterType === "24hr") {
                        self.$('.active-range').removeClass('active-range');
                        self.$('#24hr-range-global').addClass('active-range');
        ...
        events: {
            ...
            'click #all-range-global': 'doAllDateFilter',
            'click #24hr-range-global': 'do24HrDateFilter',
            'click #72hr-range-global': 'do72HrDateFilter',
            'click #7d-range-global': 'do7DDateFilter',
            'click #1mo-range-global': 'do1MDateFilter',
            'click #3mo-range-global': 'do3MDateFilter',
            'click #1yr-range-global': 'do1YDateFilter',
            'click #2yr-range-global': 'do2YDateFilter',
        ...
        fillSearchResultsTemplate: function() {
            ...
            for (var groupName in groupedResults) { //iterate over the groups
                ...
                for (var i = 0; i < items.length; i++) { //iterate over each item in the result group
                    ...
                    if (typeof(item.attributes.datetime) !== 'undefined') {
                        var datetimeNum = (item.attributes.datetime).toString();
                        datetime = me.util.doDatetimeConversion(datetimeNum);
                    }
                    ...
                    if ((isLabDoc || item.attributes.type === 'document' || item.attributes.type === 'problem') && count > 1) {

                        if ((item.attributes.kind === 'Pathology')) {
                        ...
                        var cleanGroupName2 = summary.replace(/[^a-zA-Z0-9]/g, ""),
                            ...
                            subGroup = me.searchResultGroupTemplate({
                                ...
                                titleElemId: 'result-subGroup-title-' + cleanGroupName2,
                                groupId: subGroupId,
                                count: count.toString(),
                                subGroup: true,
                                subGroupType: item.attributes.type,
        ...
        getDocumentDrilldownData: function(group_value, subGroupList, drilldown_type) {
            ...
            fetchOptions.onSuccess = function(collection, resp) {
                ...
                for (var subgroupData = 0; subgroupData < returnedSubGroupData.length; subgroupData++) {
                    ...
                    if (typeof(drillDownItem.datetime) !== 'undefined') {
                        datetimeNum = (drillDownItem.datetime).toString();

                        datetime = self.util.doDatetimeConversion(datetimeNum);
                    }
        ...
        doAllDateFilter: function() {
            ...
            this.$('#all-range-global').addClass('active-range');
            this.clearDateFilters();
        ...
        do2YDateFilter: function() {
            ...
            this.$('.active-range').removeClass('active-range');
            this.$('#2yr-range-global').addClass('active-range');
            this.clearDateFilters();
        ...
        do1YDateFilter: function() {
            ...
            this.doDateFilter(false);
            this.$('.active-range').removeClass('active-range');
            this.$('#1yr-range-global').addClass('active-range');
            this.clearDateFilters();
        ...
        do3MDateFilter: function() {
            ...
            this.doDateFilter(false);
            this.$('.active-range').removeClass('active-range');
            this.$('#3mo-range-global').addClass('active-range');
            this.clearDateFilters();
        ...
        do1MDateFilter: function() {
            ...
            this.doDateFilter(false);
            this.$('.active-range').removeClass('active-range');
            this.$('#1mo-range-global').addClass('active-range');
            this.clearDateFilters();
        ...
        do7DDateFilter: function() {
            ...
            this.doDateFilter(false);
            this.$('.active-range').removeClass('active-range');
            this.$('#7d-range-global').addClass('active-range');
            this.clearDateFilters();
        ...
        do72HrDateFilter: function() {
            ...
            this.doDateFilter(false);
            this.$('.active-range').removeClass('active-range');
            this.$('#72hr-range-global').addClass('active-range');
            this.clearDateFilters();
        ...
        do24HrDateFilter: function() {
            ...
            this.doDateFilter(false);
            this.$('.active-range').removeClass('active-range');
            this.$('#24hr-range-global').addClass('active-range');
            this.clearDateFilters();
