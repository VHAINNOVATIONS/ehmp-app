...
function onResolveDependencies(ADK, Backbone, Marionette, _, moment, DEV, appletHelper, DocDetailsDisplayer, OverviewDetailView, DetailCommunicator, CollectionHandler, detailWrapperTemplate, facilityNameTemplate) {
    var DEBUG = DEV.flag;
