...
function onResolveDependencies(Backbone, Marionette, _, DefaultTemplate, ConsultTemplate, RadTemplate, LabTemplate, MedTemplate, AllergyTemplate, DietTemplate, NursingTemplate, InfusionTemplate, Util) {
    'use strict';
