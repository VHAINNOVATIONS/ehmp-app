...
function onResolveDependencies(ADK, Backbone, Marionette, ModalView, ModalHeaderView, orderDateTemplate, orderStatusTemplate, siteTemplate, startDateTemplate, stopDateTemplate, orderSummaryTemplate, ToolBarView, ordersFilterTemplate, Util, DetailCommunicator) {
    'use strict';
        ...
        initialize: function(options) {
            ...
            fetchOptions.collectionConfig = {
                ...
                comparator: function(item) {
                    return [item.get('kind'), -new Date(item.get('entered')).getTime()];
                },
