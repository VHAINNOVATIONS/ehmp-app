...
function onResolveDependencies(ADK, appletHelper, _, Backbone, util, moment, tooltip) {
    ...
    var collectionHandler = {
        ...
        fetchMedsCollection: function(partialFetchOptions, viewType) {
            ...
            if (patientType.toUpperCase() === 'INPATIENT') {
                filterOptions = 'or(eq(vaType, "I"), eq(vaType, "IV"))';
        ...
        afterGroupingParse: function(response) {
            ...
            if (subMed.vaType.toUpperCase() === 'I' || subMed.vaType.toUpperCase() === 'IV') {
