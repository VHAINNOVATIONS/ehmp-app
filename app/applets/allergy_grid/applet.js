...
function onResolveDependencies(ADK, ADKApp, EnteredInError, detailsFooterTemplate, expirationCellTemplate,
    ...
    var AppletLayoutView = GridApplet.extend({
        ...
        initialize: function(options) {
            ...
            if (ADK.UserService.hasPermission('add-patient-allergy')) {
