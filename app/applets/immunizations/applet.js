...
function onResolveDependencies(ADK, Backbone, Marionette, Util, ModalView, siteTemplate, reactionTemplate, commentTemplate, administeredTemplate, modalHeader, modalFooter, CONFIG, gUtil, tooltip) {
    ...
    var AppletLayoutView = GridApplet.extend({
        initialize: function(options) {
            ...
            if (ADK.UserService.hasPermission('add-patient-immunization')) {
