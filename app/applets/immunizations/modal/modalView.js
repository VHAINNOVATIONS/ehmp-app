var dependencies = [
    ...
    "app/applets/immunizations/modal/modalHeaderView.js",
    "app/applets/immunizations/modal/modalFooterView.js"
  ];

define(dependencies, onResolveDependencies);

function onResolveDependencies($, InputMask, ADK, Backbone, Marionette, _, Util, AppletHelper, FilterDateRangeView, resultTemplate, dateTemplate, siteTemplate, modalTemplate, dateRangeTemplate, totalTestsTemplate, modalHeader, modalFooter) {
    'use strict';
