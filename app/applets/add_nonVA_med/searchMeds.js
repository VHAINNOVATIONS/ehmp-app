...
function onResolveDependencies(Backbone, Marionette, _, SearchMedsResultTemplate, SearchMedsTemplate, AddMedication, SearchUtil, SearchEventHandler, ScrollEventHandler, addFooter, util, ADK, ADKApp) {
    'use strict';
