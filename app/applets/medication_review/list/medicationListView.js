...
function onResolveDependencies(Backbone, Marionette, ADK, medicationGroupTemplate, MedicationItemView, appletHelper, medicationCollectionHandler) {
        ...
        groupByName: function() {
            ...
            var medicationNameGroups = _.map(groups, function(medications, medName) {
                return new Backbone.Model({
                    ...
                    // qualifiedName: medications[0].get('qualifiedName'),
