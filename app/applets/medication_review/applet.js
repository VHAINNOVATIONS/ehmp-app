...
function onResolveDependencies(Backbone, Marionette, ADK, _, medicationListTemplate, graphTemplate, EventHandlers, appletHelper, MedicationListView, medicationCollectionHandler, MedicationGraphItemView, DetailController) {
