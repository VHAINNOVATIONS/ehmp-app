...
function onResolveDependencies($, InputMask, moment, ADK, Backbone, Marionette, _, timelineSummaryDGTemplate, formatDateTemplate, ActivityCell, newsfeedUtils) {
    'use strict';
    ...
    var TimelineSummaryDG = Backbone.Marionette.LayoutView.extend({
        ...
        initialize: function(options) {
            ...
            ADK.Messaging.on('globalDate:customDateRangeSelected', this.fetchTimelineData());
        },
        regions: {
