                ...
                items: [{
                    ...
                    items: [{
                        ...
                        itemColumn: {
                            ...
                            columnClasses: ["percent-width-70"]
                        },
                        commentColumn: {
                ...
                items: [{
                    ...
                    items: [{
                        ...
                        additionalColumns: [{
                            ...
                            columnClasses: ["percent-width-20", "text-center"],
                            columnTitle: "Provider",
                            control: "select",
                            extraClasses: ["input-sm", "percent-width-90", "all-margin-no"],
                            name: "provider",
                            label: "Provider",
                            srOnlyLabel: true,
