    ...
    var F414 = {
        ...
        createForm: function() {
            ...
            var lowerBodyContainer = {
                control: "container",
                extraClasses: ["row"],
                items: [selectProblemContainer, statusContainer, immediacyContainer, onsetDateContainer, clinicContainer, resProviderContainer, treatmentFactorsContainer, annotationsContainer]
            };
            // *********************************************** END OF CONTAINERS ****************************************
            ...
            var F414_SelectProblemFields = [{
                ...
                items: [{
                    ...
                    items: [warningContainer, lowerBodyContainer]
                }]
            }, {
                // **************************************** Modal Footer Start ******************************************
                control: "container",
