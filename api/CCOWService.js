...
function onResolveDependencies($, ResourceService, Messaging, Navigation, SessionStorage, UserService, ccowModalView, ScreensManifest) {
    'use strict';
    ...
    var CCOWService = {
        ...
        loadPatientOnCoverSheet: function (patient) {
            ...
            Navigation.navigate(ScreensManifest.defaultScreen);
        },
